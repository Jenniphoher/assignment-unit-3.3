...
for(stretchNumbers of supplyChanges) {
  if(stretchNumbers>0) {
    stretchPositives.push(stretchNumbers);
  } else if(stretchNumbers<0) {
    stretchNegatives.push(stretchNumbers);
  } else {
    stretchZeroes.push(stretchNumbers);
  }
}
